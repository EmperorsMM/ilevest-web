...
-- Apply AFTER Stages 1-3. Adds the Client Portal buyer read-model: per-service price
-- columns (values supplied later by the team), the anon quote, the buyer-state mapping,
-- and the ownership-scoped order-tracking projection. One transaction; re-runnable.
-- =============================================================================
begin;
