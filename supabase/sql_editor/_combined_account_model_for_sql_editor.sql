-- =============================================================================
-- Ilevest — Account model: Admin provisioning + client deactivate-and-anonymize
-- (Supabase SQL Editor). Apply AFTER Stages 1-4. Idempotent; one transaction.
--
-- SECURITY NOTE: this TIGHTENS the admin role. After this runs, an admin can provision and
-- govern staff accounts but can NO LONGER seal a verdict or assign work (is_ops/is_reviewer
-- no longer count 'admin'). That is the intended CISO boundary.
-- =============================================================================
begin;
-- =============================================================================
